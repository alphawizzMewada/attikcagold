              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        text("₹"+model.productDetails![0].variants![0].price.toString(), fontSize: 14.sp, fontFamily: fontBold),
                        boxWidth(10),
                      /*  Image.asset(
                          "images/star.png",
                          width: getHeight(20),
                   ...
                   /* parseInt(model.qty)<1?Container(
                      width: getWidth(152),
                      decoration: boxDecoration(
                        radius: 10,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      text("₹"+model.orderItems![0].price.toString(), fontSize: 14.sp, fontFamily: fontMedium),
                    ],
                  ),
                  boxHeight(20),
                  Row(
